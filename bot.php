              ...
              $bot->sendMessage([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'✔️ بدء الصيد ','callback_data'=>'run'],['text'=>'❌ إيقاف الصيد','callback_data'=>'stop']],
                          [['text'=>'♻️ حاله الاده','callback_data'=>'status']],
                      ]
                  ])
              ]);   
          } elseif($text != null){
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'⚠️ لسته جديده','callback_data'=>'newList'],['text'=>'⚠️ لسته قديمة','callback_data'=>'append']],
