...
$mail = strtolower($mail);
        ...
        } elseif(preg_match('/(hotmail|outlook)\.(com)/', $mail)){
...
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36"); 
...
function check_ban($gmail){
    ...
    $c = curl_init("https://accounts.google.com/signin/v2/identifier?flowName=GlifWebSignIn&flowEntry=ServiceLogin"); 
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1"); 
    curl_setopt($c, CURLOPT_HTTPHEADER, $header); 
...
function checkGmail($mail){
  ...
  $mail = preg_replace('/@(.*)/', '',$mail);
   $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,'https://accounts.google.com/signin/v2/identifier?flowName=GlifWebSignIn&flowEntry=ServiceLogin');
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
...
'client-request-id: 0ce76b27aff241449bd894120740d791',
'content-type: application/json; charset=UTF-8',
'cookie: mkt=en-GB; MSCC=35.242.228.105-DE; uaid=0ce76b27aff241449bd894120740d791; MSPRequ=id=N&lt=1634654288&co=1; MSCC=64.62.245.20-US; OParams=11O.DV7Z6aEYCUSKNXih*jY7PAO2y2UKmTvE6o7YcspimAEZofZ4anSyQbByjkfAwkOJytUcVpsaiatZTRZNPwZPO3*r0DK*PyDgG0aqf9hT4*frrxS5*1z8j0cYJNhDKcf0sO4W7gVgbzjFfKLXhUFtH*8m1ALyyCYsWkqVUcjsG*ItGdQ!tlXteor1kzNArh4c88SV4qdT3y5VMEtVMbq9cME$; MSPOK=$uuid-891942a2-0fab-4554-b238-442ef0f4c014',
'hpgact: 0',
'hpgid: 33',
